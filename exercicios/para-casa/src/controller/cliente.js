...
const excluirCliente = (req,res)=>{
    ...
    if(localizarCliente){
        ...
        return res.status(200).json(`O usuário foi deletado `)
    }
    return res.status(404).json("Cliente não encontarado")
  }
...
module.exports = {novoCliente, atualizarCliente, excluirCliente, findCostumer}
